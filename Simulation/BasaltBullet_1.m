...
%}
    ...
    scatter(coorbar(:,1),coorbar(:,2),12,P,'filled')
    ...
    subplot(1,2,2)
    %plot(coorbar(:,1), coorbar(:,2),'.b')
    scatter(coorbar(:,1),coorbar(:,2),12,dev12,'filled')
    axis([-0.0254 0.0254 -0.001 0.02])
    caxis([-8e4,8e4])
    colorbar()
    title('Tau12')
