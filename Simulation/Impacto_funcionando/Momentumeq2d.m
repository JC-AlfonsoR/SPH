...
for i=1:length(Npart)
    ...
    dV1 = dV1 + mb*(sigma11a*rhoa21+sigma11b*rhob21+Mgh)*dW(1)*f_f/5000000 +...
        mb*(sigma12a*rhoa21+sigma12b*rhob21)*dW(2)*f_f/10000000;
    dV2 = dV2 + mb*(sigma21a*rhoa21+sigma21b*rhob21)*dW(1)*f_f/8000 +...
        mb*(sigma22a*rhoa21+sigma22b*rhob21+Mgh)*dW(2)*f_f/500000; % *10 e6 arbitrario para generar este desplazamiento
    
    % Correcciones Camilo
    %dV1 = dV1 + mb*(sigma12a*rhoa21 + sigma12b*rhob21) * dW(2)/dy;
    %dV2 = dV2 + mb*(sigma21a*rhoa21 + sigma21b*rhob21) * dW(1)/dx;
end
%% Referencias
%{
