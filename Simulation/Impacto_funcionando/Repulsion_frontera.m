function [ dV1,dV2 ] = Repulsion_frontera( Particles, selfpart, Near_Part, Dist,...
    r0, n1, n2, M, V_sc)
%% Repulsion
...
% D         double      Factor de Escala
                        % Antes estaba como parametro, ahora lo calculo
                        % en esta funcion
%V_sc       N_part*1    Velocidad al cuadrado
